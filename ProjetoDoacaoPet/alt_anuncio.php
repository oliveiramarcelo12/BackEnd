...
if (!empty($_GET['id_anuncio'])) {
    ...
    try {
        ...
        if ($stmt->rowCount() == 1) {
            ...
            $result = $stmt->fetch(); // Obter o resultado único
        } else {
    ...
    // Se $_GET['id_anuncio'] estiver vazio
    header("Location: index_logado.php?msgErro=ID de anúncio não fornecido.");
    die();
}

// Aqui você pode usar a variável $result que contém as informações do anúncio encontrado
?>

<html lang="en" dir="ltr">
<head>
<meta charset="utf-8">
<title>Alterar Anúncio</title><link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.1/dist/css/bootstrap.min.css"
...
<option selected>Selecione o porte do animal</option><option value="P" <?php echo $result['porte'] == 'P' ? "selected" : ""
